        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estante = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    Especificacion = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "HerramientasUnidades",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    HerramientaId = table.Column<Guid>(type: "uuid", nullable: false),
                    Estado = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HerramientasUnidades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HerramientasUnidades_Herramientas_HerramientaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HerramientaUnidadId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrestamosDetalles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrestamosDetalles_HerramientasUnidades_HerramientaUnidadId",
                        column: x => x.HerramientaUnidadId,
                        principalTable: "HerramientasUnidades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HerramientasUnidades_HerramientaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrestamosDetalles_HerramientaUnidadId",
                table: "PrestamosDetalles",
                column: "HerramientaUnidadId");
